...
from s1_omni.protein_folding.boltz_data_pipeline.types import Structure
from s1_omni.protein_folding.boltz_data_pipeline.write.utils import generate_tags
